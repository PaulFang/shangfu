...
<title>尚孚·世家之交-茶油-产品展示-尚孚茶油</title>
</head>
<body>
...
<div class="wrapper">
    ...
    <div class="main">
        ...
        <div class="product-detail">
            ...
            <div class="photos">
                <div class="detail">
				   <a href='product_img/yichu/main.jpg' class='cloud-zoom' id='zoom1' rel="adjustX:10, adjustY:-4">
				    <img src="product_img/yichu/main.jpg">
				   </a>
				</div>
				<div class="photoList">
                    ...
                    <div class="contents">
                        <ul>
						    <li class="current">
							    <a href='product_img/yichu/main.jpg' class='cloud-zoom-gallery' rel="useZoom: 'zoom1', smallImage: 'product_img/yichu/main.jpg' ">
								   <img src="product_img/yichu/main.jpg"/>
								</a>
                            </li>
							<li class="current">
							    <a href='product_img/yichu/1.jpg' class='cloud-zoom-gallery' rel="useZoom: 'zoom1', smallImage: 'product_img/yichu/1.jpg' ">
								   <img src="product_img/yichu/1.jpg"/>
								</a>
                            </li>
							<li class="current">
							    <a href='product_img/yichu/2.jpg' class='cloud-zoom-gallery' rel="useZoom: 'zoom1', smallImage: 'product_img/yichu/2.jpg' ">
								   <img src="product_img/yichu/2.jpg"/>
								</a>
                            </li>
							<!--<li class="current">
							    <a href='product_img/yichu/3.jpg' class='cloud-zoom-gallery' rel="useZoom: 'zoom1', smallImage: 'product_img/yichu/3.jpg' ">
								   <img src="product_img/yichu/3.jpg"/>
								</a>
                            </li> -->
                            <li class="current">
							    <a href='product_img/yichu/1.jpg' class='cloud-zoom-gallery' rel="useZoom: 'zoom1', smallImage: 'product_img/yichu/1.jpg' ">
            ...
            <div class="info">
				...
				<p style="text-align:center;">品质生活，“油”厨房开始。</p>
                <p style="text-align:center;"> 尚孚·宜厨有机山茶油，倡导新厨意，新生活。</p>
                
                <div class="cartBox">
                    <a href="https://detail.1688.com/offer/528908465159" target="_blank" class="cart" style=" margin-left:30px;"><i></i>立即订购</a>
