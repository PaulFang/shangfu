...
<div class="wrapper">
    ...
    <div class="main">
        ...
        <div class="product-detail">
            ...
            <div class="photos">
                <div class="detail">
				   <a href='product_img/chakubin/main.jpg' class='cloud-zoom' id='zoom1' rel="adjustX:10, adjustY:-4">
				    <img src="product_img/chakubin/main.jpg">
				   </a>
				</div>
				<div class="photoList">
                    ...
                    <div class="contents">
                        <ul>
						    <li class="current">
							    <a href='product_img/chakubin/1.jpg' class='cloud-zoom-gallery' rel="useZoom: 'zoom1', smallImage: 'product_img/chakubin/1.jpg' ">
								   <img src="product_img/chakubin/1.jpg"/>
								</a>
                            </li>
							
							<li class="current">
							    <a href='product_img/chakubin/2.jpg' class='cloud-zoom-gallery' rel="useZoom: 'zoom1', smallImage: 'product_img/chakubin/2.jpg' ">
								   <img src="product_img/chakubin/2.jpg"/>
								</a>
                            </li>
							<li class="current">
							    <a href='product_img/chakubin/1.jpg' class='cloud-zoom-gallery' rel="useZoom: 'zoom1', smallImage: 'product_img/chakubin/1.jpg' ">
							...
							<li class="current">
							    <a href='product_img/chakubin/main.jpg' class='cloud-zoom-gallery' rel="useZoom: 'zoom1', smallImage: 'product_img/chakubin/main.jpg' ">
								   <img src="product_img/chakubin/main.jpg"/>
								</a>
                            </li>
            ...
            <div class="info">
                ...
                <p> 茶枯饼，茶粕，又称茶籽饼，别名茶麸、茶枯，茶籽饼。茶枯饼是野山茶油果实通过低温物理压榨后剩下的渣，成饼状。茶枯饼广泛应用在农作物及果树栽种中，效果极佳。对淤泥少、底质贫瘠的池塘可起到增肥作用。使用茶粕作为清塘药物，比其它药物具有更独特的功效。
</p>
                
                <div class="cartBox">
                    <a href="https://detail.1688.com/offer/530437778462" target="_blank" class="cart" style=" margin-left:30px;"><i></i>立即订购</a>
